            ...
            modelBuilder.Entity("BackEnd.Models.Memory", b =>
                {
                    ...
                    b.Property<int?>("MotherboardID1")
                        .HasColumnType("int");

                    b.Property<int?>("MotherboardID2")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MotherboardID1");

                    b.HasIndex("MotherboardID2");
            ...
            modelBuilder.Entity("BackEnd.Models.Memory", b =>
                {
                    ...
                    b.HasOne("BackEnd.Models.Motherboard", null)
                        .WithMany("RAM")
                        .HasForeignKey("MotherboardID1");

                    b.HasOne("BackEnd.Models.Motherboard", null)
                        .WithMany("SATA")
                        .HasForeignKey("MotherboardID2");
                });
